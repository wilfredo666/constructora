...
class ModeloProveedor{
  ...
  static public function mdlRegProveedor($data){
    ...
    $stmt=Conexion::conectar()->prepare("INSERT INTO proveedor(nombre_empresa, nombre_pro, ap_paterno_pro, ap_materno_pro, ci_proveedor, direccion_pro, telefono_pro, email_pro) VALUES ('$nombre_empresa','$nombre_pro','$ap_paterno_pro','$ap_materno_pro','$ci_proveedor','$direccion_pro','$telefono_pro','$email_pro')");
