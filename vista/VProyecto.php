        ...
        <table id="DataTable" class="table table-bordered table-striped">
            <thead>
                <tr>
                    ...
                    <th>Estado</th>
                    <td>
                        <button class="btn btn-block btn-primary btn-sm" onclick="MNuevoProyecto()"> <i
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <button class="btn btn-sm btn-secondary"
                                onclick="MEditProyecto(<?php echo $value["id_proyecto"]; ?>)">
                                <i class="fas fa-edit"></i>
                            </button>
                            <button class="btn btn-sm btn-danger"
                                onclick="MEliProyecto(<?php echo $value["id_proyecto"]; ?>)">
