    ...
    <table id="DataTable" class="table table-bordered table-striped">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <div class="btn-group">
              <button class="btn btn-sm btn-secondary" onclick="MEditInmueble(<?php echo $value['id_item']; ?>)">
                <i class="fas fa-edit"></i>
              </button>
              <button class="btn btn-sm btn-danger" onclick="MEliInmueble(<?php echo $value['id_item']; ?>)">
