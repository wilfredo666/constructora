...
<form action="" id="FormEditProyecto">
    <div class="modal-body">
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="codProyecto" name="codProyecto" readonly
                        value="<?php echo $proyecto["cod_proyecto"]; ?>">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nomProyecto" name="nomProyecto"
                        value="<?php echo $proyecto["nombre_proyecto"]; ?>">
                </div>
            </div>
        </div>
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="descProyecto" name="descProyecto"
                value="<?php echo $proyecto["desc_proyecto"]; ?>">
        </div>
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
        ...
        <div class="row">
            ...
            ?>
                        <option value="<?php echo $value["id_personal"]; ?>" selected>
                            <?php echo $value["nombre"] . " " . $value["ap_paterno"] . " " . $value["ap_materno"]; ?>
                        </option>
                        <?php
              } else {
              ?>
                        <option value="<?php echo $value["id_personal"]; ?>">
                            <?php echo $value["nombre"] . " " . $value["ap_paterno"] . " " . $value["ap_materno"]; ?>
                        </option>
                        <?php
              }
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <select name="estadoProyecto" id="estadoProyecto" class="form-control">
                        <option value="1" <?php if ($proyecto["estado_proyecto"] == 1) : ?> selected <?php endif; ?>>
                            Activo</option>
                        <option value="0" <?php if ($proyecto["estado_proyecto"] == 0) : ?> selected <?php endif; ?>>
                            Inactivo</option>
                    </select>
                </div>
            </div>
